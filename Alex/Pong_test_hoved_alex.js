...
/*ballen går utover siden = function() {
	points1 += 1;
document.getElementById('pointsplayer1').textContent = points1;
}
//ballen går utover siden = function() {
	points2 += 1;
document.getElementById('pointsplayer2').textContent = points2;
}*/
...
Ball.prototype.update = function(paddle1, paddle2){
  ...
  var poeng_spiller_1_ut = document.getElementById("scoreplayer1");
  var poeng_spiller_2_ut = document.getElementById("scoreplayer2");
   ...
   if (this.x < 0) {
     ...
     this.y = 200;
     pointsplayer1++;
     poeng_spiller_1_ut.textContent = pointsplayer1;
   } else if (this.x > 600) {
     this.x_speed = 3;
     random_speed_y = Math.floor(Math.random()*y_speed_array.length);
     this.y_speed = y_speed_array[random_speed_y];
     ...
     this.y = 200;
     pointsplayer2++;
     poeng_spiller_2_ut.textContent = pointsplayer2;
   }
   if (pointsplayer1 === 7) {
     pointsplayer1 = 0;
  ...
  if (top_x > 300) {
    if (top_y < (paddle1.x + paddle1.width) && bottom_x > paddle1.x && top_y < (paddle1.y + paddle1.height) && bottom_y > paddle1.y) {
      this.x_speed = -3;
